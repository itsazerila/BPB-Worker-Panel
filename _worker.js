...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `zfd - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `zfd - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `zfd - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `zfd - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'zfd Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'zfd Frag - Best Ping 💥';
    ...
    bestFragment.remarks = 'zfd Frag - Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWarpBestPing.remarks = 'zfd - Warp Best Ping 🚀'
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = `zfd - WoW ${index/2 + 1} 🌍`;
